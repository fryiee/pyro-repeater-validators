...
/**
 * Class ValidateFieldValueMinimumAmount
 *
...
class ValidateFieldValueMinimumAmount
{
    ...
    public function handle(RepeaterFieldType $fieldType, $streamFieldName, $parentFormAssignments, $arguments, $parentFormBuilder)
    {
        ...
        $errorMessage = 'The ' . $streamFieldName . ' repeater must contain a minimum ' . $occurrences . ' ' . (str_plural('row', $occurrences)) . ' of the ' . $attribute . ' equal to ' . $valueToCheckFor . '.';
