...
/**
 * Class ValidateFieldValueAmount
 *
...
class ValidateFieldValueAmount
{
    ...
    public function handle(RepeaterFieldType $fieldType, $streamFieldName, $parentFormAssignments, $arguments, $parentFormBuilder)
    {
        ...
        $errorMessage = 'The ' . $streamFieldName . ' repeater must contain ' . $occurrences . ' ' . (str_plural('row', $occurrences)) . ' of the ' . $attribute . ' equal to ' . $valueToCheckFor . '.';
